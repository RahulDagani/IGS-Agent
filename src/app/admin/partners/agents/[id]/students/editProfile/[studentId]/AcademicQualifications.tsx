...
export default function AcademicQualifications() {
  ...
  const fetchAcademicRecords = async () => {
    try {
      setLoading(true);
      const response = await fetch(`${BASE_URL}/tenant/agent/student/academic/records/${studentId}`, {
        headers: {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const url = editingId 
        ? `${BASE_URL}/tenant/agent/student/academic/records/${studentId}/${editingId}`
        : `${BASE_URL}/tenant/agent/student/academic/records/${studentId}`;
