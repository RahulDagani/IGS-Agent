...
export default function StepsGrid() {
  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      href: `/admin/partners/students/${studentId}/application-form`,
    },
    {
      id: 3,
      title: "Step 3",
      ...
      href: `/admin/partners/students/${studentId}/documents`,
    },
    {
      id: 4,
      title: "Step 4",
      ...
      href: `/admin/partners/students/${studentId}/applications`,
    },
  ];
